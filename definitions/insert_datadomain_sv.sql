...
insert into zz_strat(geoshort,strata) values('unknown','okänt');
insert into zz_strat(geoshort,strata) values('','okänt');
insert into zz_strat(geoshort,strata) values(' ','okänt');
insert into zz_strat(geoshort,strata) values('okänt','okänt');
insert into zz_strat(geoshort,strata) values('okänd','okänt');
insert into zz_strat(geoshort,strata) values('inget prov','okänt');
insert into "zz_stratigraphy_plots" (strata,color_mplot,hatch_mplot,color_qt,brush_qt) values('okänt','white','','white','NoBrush');
...
insert into "zz_stratigraphy_plots" (strata,color_mplot,hatch_mplot,color_qt,brush_qt) values('grovsand','green','*','green','Dense5Pattern');
insert into "zz_stratigraphy_plots" (strata,color_mplot,hatch_mplot,color_qt,brush_qt) values('sand','green','*','green','Dense5Pattern');
insert into "zz_stratigraphy_plots" (strata,color_mplot,hatch_mplot,color_qt,brush_qt) values('mellansand','green','.','green','Dense4Pattern');
insert into "zz_stratigraphy_plots" (strata,color_mplot,hatch_mplot,color_qt,brush_qt) values('finsand','DarkOrange','.','orange','Dense5Pattern');
...
insert into "zz_stratigraphy_plots" (strata,color_mplot,hatch_mplot,color_qt,brush_qt) values('lera','yellow','-','yellow','HorPattern');
