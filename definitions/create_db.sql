...
#select InitSpatialMetadata(1); #Not sure about this for postgis
...
insert into about_db values('meteo', 'reading_num', 'double precision', '', '', '', '', 'Value (real number) reading for the parameter', '', '');
...
insert into about_db values('obs_points', 'length', 'double precision', '', '', '', '', 'Borehole length from ground surface to bottom (equals to depth if vertical)', '', '');
insert into about_db values('obs_points', 'drillstop', 'text', '', '', '', '', 'Drill stop, e.g. probing/direct push drilling stopped against rock', '', '');
insert into about_db values('obs_points', 'diam', 'double precision', '', '', '', '', 'Inner diameter for casing or upper part of borehol', '', '');
...
insert into about_db values('obs_points', 'east', 'double precision', '', '', '', '', 'Eastern coordinate (in the corresponding CRS)', '', '');
insert into about_db values('obs_points', 'north', 'double precision', '', '', '', '', 'Northern coordinate (in the corresponding CRS)', '', '');
insert into about_db values('obs_points', 'ne_accur', 'double precision', '', '', '', '', 'Approximate inaccuracy for coordinates', '', '');
...
insert into about_db values('obs_points', 'h_toc', 'double precision', '', '', '', '', 'Elevation (masl) for the measuring point, the point from which water level is measured, normally Top Of Casing', '', '');
insert into about_db values('obs_points', 'h_tocags', 'double precision', '', '', '', '', 'Distance from Measuring point to Ground Surface (m), Top Of Casing Above Ground Surface', '', '');
insert into about_db values('obs_points', 'h_gs', 'double precision', '', '', '', '', 'Ground Surface level (m). ', '', '');
insert into about_db values('obs_points', 'h_accur', 'double precision', '', '', '', '', 'Inaccuracy (m) for Measuring Point level, h_toc', '', '');
...
insert into about_db values('seismic_data', 'length', 'double precision', '1', '', '1', '', 'Length along line', '', '');
insert into about_db values('seismic_data', 'ground', 'double precision', '', '', '', '', 'Ground surface level', '', '');
insert into about_db values('seismic_data', 'bedrock', 'double precision', '', '', '', '', 'Interpreted level for bedrock surface', '', '');
insert into about_db values('seismic_data', 'gw_table', 'double precision', '', '', '', '', 'Interpreted level for limit between unsaturated/saturated conditions', '', '');
...
insert into about_db values('stratigraphy', 'depthtop', 'double precision', '', '', '', '', 'Depth, from surface level, to top of the stratigraphy layer', '', '');
insert into about_db values('stratigraphy', 'depthbot', 'double precision', '', '', '', '', 'Depth, from surface level, to bottom of the stratigraphy layer', '', '');
...
insert into about_db values('vlf_data', 'length', 'double precision', '1', '', '1', '', 'Length along line', '', '');
insert into about_db values('vlf_data', 'real_comp', 'double precision', '', '', '', '', 'Raw data real component (in-phase(%))', '', '');
insert into about_db values('vlf_data', 'imag_comp', 'double precision', '', '', '', '', 'Raw data imaginary component', '', '');
...
insert into about_db values('w_flow', 'reading', 'double precision', '', '', '', '', 'Value (real number) reading for the flow rate, accumulated volume etc', '', '');
...
insert into about_db values('w_levels', 'meas', 'double precision', '', '', '', '', 'distance from measuring point to water level', '', '');
insert into about_db values('w_levels', 'h_toc', 'double precision', '', '', '', '', 'Elevation (masl) for the measuring point at the particular date_time (measuring point elevation may vary by time)', '', '');
insert into about_db values('w_levels', 'level_masl', 'double precision', '', '', '', '', 'Water level elevation (masl) calculated from measuring point and distance from measuring point to water level', '', '');
...
insert into about_db values('w_levels_logger', 'head_cm', 'double precision', '', '', '', '', 'pressure (cm water column) on pressure transducer', '', '');
insert into about_db values('w_levels_logger', 'temp_degc', 'double precision', '', '', '', '', 'temperature degrees C', '', '');
insert into about_db values('w_levels_logger', 'cond_mscm', 'double precision', '', '', '', '', 'electrical conductivity mS/cm', '', '');
insert into about_db values('w_levels_logger', 'level_masl', 'double precision', '1', '-999', '', '', 'Corresponding Water level elevation (masl)', '', '');
...
insert into about_db values('w_qual_field', 'reading_num', 'double precision', '', '', '', '', 'Value as real number', '', '');
...
insert into about_db values('w_qual_field', 'depth', 'double precision', '', '', '', '', 'The depth at which the measurement was done', '', '');
...
insert into about_db values('w_qual_lab', 'depth', 'double precision', '', '', '', '', 'Depth (m below h_gs) from where sample is taken', '', '');
...
insert into about_db values('w_qual_lab', 'reading_num', 'double precision', '', '', '', '', 'Value as real number', '', '');
...
insert into about_db values('zz_capacity', '*', '', '', '', '', '', 'data domain for stratigraphy classes, plot colors, symbols and geological short names used by the plugin', '', '');
...
create table obs_points ( obsid text not null, name text, place text, type text, length double precision, drillstop text, diam double precision, material text, screen text, capacity text, drilldate text, wmeas_yn integer, wlogg_yn integer, east double precision, north double precision, ne_accur double precision, ne_source text,  h_toc double precision, h_tocags double precision, h_gs double precision, h_accur double precision, h_syst text, h_source text, source text, com_onerow text, com_html text, primary key (obsid));
SELECT AddGeometryColumn ('public','obs_points','geometry',CHANGETORELEVANTEPSGID,'POINT',2);
create table obs_lines (obsid text  not null, name text, place text, type text, source text, primary key (obsid));
SELECT AddGeometryColumn ('public','obs_lines','geometry',CHANGETORELEVANTEPSGID,'LINESTRING',2);
create table w_levels (obsid text not null, date_time text not null, meas double precision, h_toc double precision, level_masl double precision, comment text, primary key (obsid, date_time),  foreign key(obsid) references obs_points(obsid));
create table w_levels_logger (obsid text not null, date_time text not null, head_cm double precision, temp_degc double precision, cond_mscm double precision, level_masl double precision, comment text, primary key (obsid, date_time),  foreign key(obsid) references obs_points(obsid));
create table stratigraphy (obsid text not null, stratid integer not null, depthtop double precision, depthbot double precision, geology text, geoshort text, capacity text, development text,  comment text, primary key (obsid, stratid), foreign key(obsid) references obs_points(obsid));
create table w_qual_field (obsid text not null, staff text, date_time text not null, instrument text, parameter text not null, reading_num double precision, reading_txt text, unit text, depth double precision, comment text, primary key(obsid, date_time, parameter, unit), foreign key(obsid) references obs_points(obsid), foreign key(staff) references zz_staff(staff));
create table w_qual_lab (obsid text not null, depth double precision, report text not null, project text, staff text, date_time text, anameth text, parameter text not null, reading_num double precision, reading_txt text, unit text, comment text, primary key(report, parameter), foreign key(obsid) references obs_points(obsid), foreign key(staff) references zz_staff(staff));
create table w_flow (obsid text not null, instrumentid text not null, flowtype text not null, date_time text not null, reading double precision, unit text, comment text, primary key (obsid, instrumentid, flowtype, date_time), foreign key(obsid) references obs_points(obsid), foreign key (flowtype) references zz_flowtype(type));
CREATE TABLE meteo (obsid text not null, instrumentid text not null, parameter text not null, date_time text not null, reading_num double precision, reading_txt text, unit text, comment text, primary key (obsid, instrumentid, parameter, date_time), foreign key(obsid) references obs_points(obsid), foreign key (parameter) references zz_meteoparam(parameter));
create table seismic_data (obsid text not null, length double precision not null, ground double precision, bedrock double precision, gw_table double precision, comment text, primary key (obsid, Length), foreign key (obsid) references obs_lines(obsid));
create table vlf_data (obsid text not null, length double precision not null, real_comp double precision, imag_comp double precision, comment text, primary key (obsid, Length), foreign key (obsid) references obs_lines(obsid));
...
create view obs_p_w_qual_field as select distinct a.CTID as rowid, a.obsid as obsid, a.geometry as geometry from obs_points as a JOIN w_qual_field as b using (obsid);
create view obs_p_w_qual_lab as select distinct a.CTID as rowid, a.obsid as obsid, a.geometry as geometry from obs_points as a JOIN w_qual_lab as b using (obsid);
create view obs_p_w_strat as select distinct a.CTID as rowid, a.obsid as obsid, a.h_toc as h_toc, a.h_gs as h_gs, a.geometry as geometry from obs_points as a JOIN stratigraphy as b using (obsid);
create view obs_p_w_lvl as select distinct a.CTID AS rowid, a.obsid AS obsid, a.geometry AS geometry FROM obs_points AS a JOIN w_levels AS b USING (obsid);
create view w_lvls_last_geom as select b.CTID as rowid, a.obsid as obsid, MAX(a.date_time) as date_time,  a.meas as meas,  a.level_masl as level_masl, b.geometry as geometry from w_levels as a JOIN obs_points as b using (obsid) GROUP BY obsid;
...
create view w_qual_lab_geom as select w_qual_lab.CTID as rowid, w_qual_lab.obsid, w_qual_lab.depth, w_qual_lab.report, w_qual_lab.staff, w_qual_lab.date_time, w_qual_lab.anameth, w_qual_lab.parameter, w_qual_lab.reading_txt, w_qual_lab.reading_num, w_qual_lab.unit, obs_points.geometry as geometry  from w_qual_lab, obs_points where w_qual_lab.obsid=obs_points.obsid;
create view w_levels_geom as select b.CTID as rowid, a.obsid as obsid, a.date_time as date_time,  a.meas as meas,  a.h_toc as h_toc,  a.level_masl as level_masl, b.geometry as geometry from w_levels as a join obs_points as b using (obsid);
...
#OK
#Not sure about these for postgis:
