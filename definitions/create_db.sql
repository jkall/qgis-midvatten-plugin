...
insert into about_db values('comments', 'comment', 'text', '1', '', '', '', 'comment connected to obsid', '', '');
insert into about_db values('comments', 'staff', 'text', '1', '', '', 'zz_staff(staff)', 'initials of the staff who made the comment', '', '');
