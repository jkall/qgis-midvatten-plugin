...
CREATE TABLE zz_lab_parameters /*Data domain for lab parameter synonyms*/(
synonym text NOT NULL --Synonym for the parameter. ex Natrium, Na, Natrium Na, Natrium.
, parameter text NOT NULL --Natrium, Na etc
, PRIMARY KEY(synonym)
);
