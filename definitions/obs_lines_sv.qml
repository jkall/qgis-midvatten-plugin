...
<qgis version="2.6.1-Brighton" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="1" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <aliases>
    <alias field="name" index="1" name="obsnamn"/>
    <alias field="place" index="2" name="plats"/>
    <alias field="source" index="4" name="referens/ursprung"/>
    <alias field="type" index="3" name="obstyp"/>
  </aliases>
  <excludeAttributesWMS/>
  <excludeAttributesWFS/>
  <attributeEditorForm>
    <attributeEditorContainer name="observation line">
      ...
      <attributeEditorField index="4" name="source"/>
