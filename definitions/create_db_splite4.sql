...
create table "vlf_data" (obsid text not null, length double not null, real_comp double, comment text, imag_comp double, primary key (obsid, Length), foreign key (obsid) references obs_lines(obsid));
