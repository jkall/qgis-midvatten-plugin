        ...
        <Option type="Map">
          ...
          <Option name="properties" type="Map">
            <Option name="PositionX" type="Map">
              ...
              <Option name="expression" type="QString" value="X($geometry)+2/**{map_scale}*/ /**{xfactor}*/"/>
