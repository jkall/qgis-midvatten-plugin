...
<qgis readOnly="0" hasScaleBasedVisibilityFlag="0" simplifyDrawingTol="1" version="3.16.3-Hannover" simplifyMaxScale="1" minScale="100000000" simplifyLocal="1" maxScale="0" labelsEnabled="0" simplifyDrawingHints="0" styleCategories="AllStyleCategories" simplifyAlgorithm="0">
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      ...
      <placement polygonPlacementFlags="2" centroidInside="0" layerType="UnknownGeometry" distMapUnitScale="3x:0,0,0,0,0,0" maxCurvedCharAngleIn="25" lineAnchorType="0" placement="1" offsetUnits="MapUnit" dist="0" rotationAngle="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" distUnits="MM" centroidWhole="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" overrunDistance="0" geometryGeneratorType="PointGeometry" repeatDistanceUnits="MM" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" yOffset="0" offsetType="0" repeatDistance="0" geometryGeneratorEnabled="0" placementFlags="10" geometryGenerator="geom_from_wkt( format('POINT(%1 %2)', &#xa;X($geometry)+2 /**{xfactor}*/, Y($geometry) - (&quot;meas&quot; - &quot;h_tocags&quot;) /**{yfactor}*/))" quadOffset="2" xOffset="0" maxCurvedCharAngleOut="-25" lineAnchorPercent="0.5" preserveRotation="1" priority="5" overrunDistanceUnit="MM" fitInPolygonOnly="0"/>
