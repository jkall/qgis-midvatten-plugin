...
<qgis styleCategories="AllStyleCategories" simplifyLocal="1" simplifyMaxScale="1" simplifyDrawingHints="0" version="3.16.3-Hannover" labelsEnabled="1" hasScaleBasedVisibilityFlag="0" minScale="100000000" simplifyAlgorithm="0" simplifyDrawingTol="1" maxScale="0" readOnly="0">
  <flags>
  ...
  <renderer-v2 symbollevels="1" enableorderby="0" type="RuleRenderer" forceraster="0">
    <rules key="{087190a1-de22-4689-b4ec-9dd48222d5cc}">
      <rule filter="LOWER(&quot;drillstop&quot;) LIKE '%berg%' " label="bedrock" symbol="0" key="{64c51113-aacc-449d-bad6-e9b98563d6a7}"/>
    </rules>
    <symbols>
      <symbol alpha="1" force_rhr="0" name="0" type="marker" clip_to_extent="1">
        <layer enabled="1" pass="1" locked="0" class="GeometryGenerator">
          ...
          <prop k="geometryModifier" v="geom_from_wkt( format('POLYGON((%1 %2, %3 %4, %5 %6, %1 %2))', &#xa;X($geometry), Y($geometry) + 0.5 /**{yfactor}*/ - &quot;soildepth&quot; /**{yfactor}*/, &#xa;X($geometry)+1.5 /**{xfactor}*/, Y($geometry) - 1 /**{yfactor}*/ - &quot;soildepth&quot; /**{yfactor}*/, &#xa;X($geometry)-1.5 /**{xfactor}*/, Y($geometry) - 1 /**{yfactor}*/ - &quot;soildepth&quot; /**{yfactor}*/))"/>
