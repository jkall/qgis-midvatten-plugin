...
<qgis readOnly="0" hasScaleBasedVisibilityFlag="0" simplifyDrawingTol="1" version="3.16.3-Hannover" simplifyMaxScale="1" minScale="100000000" simplifyLocal="1" maxScale="0" labelsEnabled="0" simplifyDrawingHints="0" styleCategories="AllStyleCategories" simplifyAlgorithm="0">
  <flags>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
          ...
          <Option type="Map">
            ...
            <Option type="Map" name="properties">
              ...
              <Option type="Map" name="PositionY">
                <Option type="bool" name="active" value="true"/>
                <Option type="QString" name="expression" value="Y($geometry) - (&quot;meas&quot; - &quot;h_tocags&quot;)*0.001*@map_scale /**{yfactor}*/"/>
                <Option type="int" name="type" value="3"/>
              </Option>
            </Option>
            <Option type="QString" name="type" value="collection"/>
      ...
      <placement polygonPlacementFlags="2" centroidInside="0" layerType="UnknownGeometry" distMapUnitScale="3x:0,0,0,0,0,0" maxCurvedCharAngleIn="25" lineAnchorType="0" placement="1" offsetUnits="MM" dist="0" rotationAngle="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" distUnits="MM" centroidWhole="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" overrunDistance="0" geometryGeneratorType="PointGeometry" repeatDistanceUnits="MM" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" yOffset="0" offsetType="0" repeatDistance="0" geometryGeneratorEnabled="0" placementFlags="10" geometryGenerator="geom_from_wkt( format('POINT(%1 %2)', &#xa;X($geometry)+2*0.001*@map_scale /**{xfactor}*/, Y($geometry) - (&quot;meas&quot;*0.001*@map_scale - &quot;h_tocags&quot;*0.001*@map_scale) /**{yfactor}*/))&#xa;" quadOffset="2" xOffset="0" maxCurvedCharAngleOut="-25" lineAnchorPercent="0.5" preserveRotation="1" priority="5" overrunDistanceUnit="MM" fitInPolygonOnly="0"/>
      ...
      <dd_properties>
        <Option type="Map">
          ...
          <Option type="Map" name="properties">
            ...
            <Option type="Map" name="PositionX">
              <Option type="bool" name="active" value="true"/>
              <Option type="QString" name="expression" value="X($geometry)+2*0.001*@map_scale * 1.0"/>
              <Option type="int" name="type" value="3"/>
            </Option>
            <Option type="Map" name="PositionY">
              <Option type="bool" name="active" value="true"/>
              <Option type="QString" name="expression" value="Y($geometry) - (&quot;meas&quot; - &quot;h_tocags&quot;)*0.001*@map_scale * 1.0"/>
              <Option type="int" name="type" value="3"/>
            </Option>
          </Option>
          <Option type="QString" name="type" value="collection"/>
