...
<qgis readOnly="0" hasScaleBasedVisibilityFlag="0" simplifyDrawingTol="1" version="3.16.3-Hannover" simplifyMaxScale="1" minScale="100000000" simplifyLocal="1" maxScale="0" labelsEnabled="1" simplifyDrawingHints="0" styleCategories="AllStyleCategories" simplifyAlgorithm="0">
  ...
  <labeling type="rule-based">
    <rules key="{5a016a52-b12f-44b4-834a-8fe1b69dbf5e}">
      <rule filter="LOWER(&quot;drillstop&quot;) LIKE '%berg%' " key="{c29c7879-8c76-4e7d-bd6e-fde44421447f}">
        <settings calloutType="simple">
          <text-style fontFamily="Noto Sans" allowHtml="0" fontSize="8" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontKerning="1" fontWeight="50" textColor="255,1,1,255" blendMode="0" fieldName="round(&quot;bedrock&quot;, 1)" fontSizeUnit="Point" capitalization="0" isExpression="1" fontUnderline="0" fontWordSpacing="0" textOrientation="horizontal" useSubstitutions="0" fontItalic="1" multilineHeight="1" textOpacity="1" previewBkgrdColor="255,255,255,255" namedStyle="Italic" fontStrikeout="0" fontLetterSpacing="0">
            <text-buffer bufferColor="255,255,255,255" bufferOpacity="1" bufferJoinStyle="128" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferDraw="1" bufferSize="0.5" bufferNoFill="1" bufferBlendMode="0" bufferSizeUnits="MM"/>
          ...
          <placement polygonPlacementFlags="2" centroidInside="0" layerType="PointGeometry" distMapUnitScale="3x:0,0,0,0,0,0" maxCurvedCharAngleIn="25" lineAnchorType="0" placement="1" offsetUnits="MM" dist="0" rotationAngle="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" distUnits="MM" centroidWhole="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" overrunDistance="0" geometryGeneratorType="PointGeometry" repeatDistanceUnits="MM" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" yOffset="0" offsetType="0" repeatDistance="0" geometryGeneratorEnabled="0" placementFlags="10" geometryGenerator="geom_from_wkt( format('POINT(%1 %2)', &#xa;X($geometry)+2*0.001*@map_scale /**{xfactor}*/, Y($geometry)))" quadOffset="2" xOffset="0" maxCurvedCharAngleOut="-25" lineAnchorPercent="0.5" preserveRotation="1" priority="5" overrunDistanceUnit="MM" fitInPolygonOnly="0"/>
            ...
            <Option type="Map">
              ...
              <Option type="Map" name="properties">
                ...
                <Option type="Map" name="PositionY">
                  <Option type="bool" name="active" value="true"/>
                  <Option type="QString" name="expression" value="Y($geometry) - &quot;soildepth&quot;*0.001*@map_scale /**{yfactor}*/ - 1*0.001*@map_scale /**{yfactor}*/"/>
                  <Option type="int" name="type" value="3"/>
                </Option>
              </Option>
              <Option type="QString" name="type" value="collection"/>
  ...
  <constraints>
    ...
    <constraint notnull_strength="0" field="h_toc" exp_strength="0" unique_strength="0" constraints="0"/>
    <constraint notnull_strength="0" field="h_gs" exp_strength="0" unique_strength="0" constraints="0"/>
    <constraint notnull_strength="0" field="h_tocags" exp_strength="0" unique_strength="0" constraints="0"/>
    <constraint notnull_strength="0" field="length" exp_strength="0" unique_strength="0" constraints="0"/>
    <constraint notnull_strength="0" field="h_syst" exp_strength="0" unique_strength="0" constraints="0"/>
    <constraint notnull_strength="0" field="ground_surface" exp_strength="0" unique_strength="0" constraints="0"/>
    <constraint notnull_strength="0" field="soildepth" exp_strength="0" unique_strength="0" constraints="0"/>
    <constraint notnull_strength="0" field="bedrock" exp_strength="0" unique_strength="0" constraints="0"/>
    <constraint notnull_strength="0" field="drillstop" exp_strength="0" unique_strength="0" constraints="0"/>
    <constraint notnull_strength="0" field="bedrock_from_table" exp_strength="0" unique_strength="0" constraints="0"/>
  </constraints>
  ...
  <attributetableconfig sortOrder="1" actionWidgetStyle="dropDown" sortExpression="&quot;soildepthh&quot;">
    <columns>
      ...
      <column type="field" name="drillstop" hidden="0" width="276"/>
      <column type="field" name="h_toc" hidden="0" width="-1"/>
      <column type="field" name="h_gs" hidden="0" width="-1"/>
      <column type="field" name="h_tocags" hidden="0" width="-1"/>
      <column type="field" name="length" hidden="0" width="-1"/>
      <column type="field" name="h_syst" hidden="0" width="-1"/>
      <column type="field" name="ground_surface" hidden="0" width="-1"/>
      <column type="field" name="bedrock" hidden="0" width="-1"/>
      <column type="field" name="bedrock_from_table" hidden="0" width="-1"/>
      <column type="field" name="soildepth" hidden="0" width="-1"/>
