...
<qgis maxScale="0" simplifyDrawingTol="1" simplifyLocal="1" minScale="100000000" hasScaleBasedVisibilityFlag="0" readOnly="0" styleCategories="AllStyleCategories" simplifyAlgorithm="0" simplifyMaxScale="1" labelsEnabled="0" simplifyDrawingHints="0" version="3.16.3-Hannover">
  ...
  <renderer-v2 type="RuleRenderer" forceraster="0" enableorderby="0" symbollevels="1">
    <rules key="{087190a1-de22-4689-b4ec-9dd48222d5cc}">
      <rule filter="LOWER(&quot;drillstop&quot;) LIKE '%berg%' " label="bedrock" key="{64c51113-aacc-449d-bad6-e9b98563d6a7}" symbol="0"/>
    </rules>
    <symbols>
      <symbol type="marker" clip_to_extent="1" name="0" alpha="1" force_rhr="0">
        <layer enabled="1" class="GeometryGenerator" locked="0" pass="1">
          <prop v="Fill" k="SymbolType"/>
          <prop v="geom_from_wkt( format('POLYGON((%1 %2, %3 %4, %5 %6, %1 %2))', &#xa;X($geometry), Y($geometry) - &quot;soildepth&quot; /**{map_scale}*/ /**{yfactor}*/ + 0.5 /**{map_scale}*/ /**{yfactor}*/, &#xa;X($geometry)+1.5 /**{map_scale}*/ /**{xfactor}*/, Y($geometry) - &quot;soildepth&quot; /**{map_scale}*/ /**{yfactor}*/ - 1 /**{map_scale}*/ /**{yfactor}*/, &#xa;X($geometry)-1.5 /**{map_scale}*/ /**{xfactor}*/, Y($geometry) - &quot;soildepth&quot; /**{map_scale}*/ /**{yfactor}*/ - 1 /**{map_scale}*/ /**{yfactor}*/))" k="geometryModifier"/>
