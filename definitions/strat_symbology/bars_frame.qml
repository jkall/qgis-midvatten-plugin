...
<qgis readOnly="0" labelsEnabled="0" simplifyMaxScale="1" simplifyDrawingHints="0" maxScale="0" simplifyAlgorithm="0" styleCategories="AllStyleCategories" minScale="100000000" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" simplifyDrawingTol="1" version="3.16.3-Hannover">
  <flags>
  ...
  <renderer-v2 type="RuleRenderer" forceraster="0" enableorderby="0" symbollevels="1">
    <rules key="{087190a1-de22-4689-b4ec-9dd48222d5cc}">
      <rule symbol="0" key="{eea648b8-39d7-4ba5-af39-202732daa572}" filter="LOWER(&quot;drillstop&quot;) LIKE '%berg%' " label="closed ending"/>
      <rule symbol="1" key="{04ea8482-b939-4daa-ab34-7b79a5a59a2a}" filter="LOWER(&quot;drillstop&quot;) NOT LIKE '%berg%' OR &quot;drillstop&quot; IS NULL " label="open ended"/>
    </rules>
    <symbols>
      <symbol name="0" clip_to_extent="1" type="marker" force_rhr="0" alpha="0.85">
      ...
      <symbol name="1" clip_to_extent="1" type="marker" force_rhr="0" alpha="0.85">
        <layer locked="0" pass="0" enabled="1" class="GeometryGenerator">
          <prop v="Line" k="SymbolType"/>
          ...
          <symbol name="@1@0" clip_to_extent="1" type="line" force_rhr="0" alpha="1">
            <layer locked="0" pass="0" enabled="1" class="SimpleLine">
              <prop v="0" k="align_dash_pattern"/>
              <prop v="square" k="capstyle"/>
              <prop v="5;2" k="customdash"/>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style textColor="0,0,0,255" textOrientation="horizontal" fontSize="8" textOpacity="1" namedStyle="" fontLetterSpacing="0" previewBkgrdColor="255,255,255,255" fontKerning="1" fontFamily="Noto Sans" capitalization="0" allowHtml="0" fontWordSpacing="0" useSubstitutions="0" fontUnderline="0" fontWeight="50" fontStrikeout="0" fieldName="obsid" blendMode="0" fontItalic="1" multilineHeight="1" isExpression="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontSizeUnit="Point">
      ...
      <placement lineAnchorType="0" offsetUnits="MM" rotationAngle="0" yOffset="0" offsetType="0" geometryGenerator="geom_from_wkt( format('POINT(%1 %2)', &#xa;X($geometry)+2*0.001*@map_scale /**{xfactor}*/, Y($geometry)))" priority="5" placement="1" placementFlags="10" fitInPolygonOnly="0" centroidInside="0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" maxCurvedCharAngleIn="25" maxCurvedCharAngleOut="-25" geometryGeneratorType="PointGeometry" distUnits="MM" geometryGeneratorEnabled="0" distMapUnitScale="3x:0,0,0,0,0,0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" repeatDistance="0" repeatDistanceUnits="MM" centroidWhole="0" quadOffset="2" dist="0" overrunDistance="0" xOffset="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" lineAnchorPercent="0.5" preserveRotation="1" polygonPlacementFlags="2" overrunDistanceUnit="MM" layerType="UnknownGeometry"/>
