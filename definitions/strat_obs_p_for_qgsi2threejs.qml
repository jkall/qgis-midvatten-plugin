  ...
  <attributeEditorForm>
    <attributeEditorContainer name="general">
      ...
      <attributeEditorContainer name="reference info">
        ...
        <attributeEditorField index="-1" name="place"/>
        <attributeEditorField index="-1" name="drilldate"/>
        <attributeEditorField index="-1" name="source"/>
      </attributeEditorContainer>
      <attributeEditorContainer name="technical info">
        <attributeEditorField index="-1" name="type"/>
        <attributeEditorField index="-1" name="length"/>
        <attributeEditorField index="-1" name="drillstop"/>
        <attributeEditorField index="-1" name="diam"/>
        <attributeEditorField index="-1" name="material"/>
        <attributeEditorField index="-1" name="screen"/>
        <attributeEditorField index="-1" name="capacity"/>
      </attributeEditorContainer>
    </attributeEditorContainer>
    <attributeEditorContainer name="xyz">
      ...
      <attributeEditorContainer name="planar coordinates - not auto-linked to map pos.">
        <attributeEditorField index="-1" name="east"/>
        <attributeEditorField index="-1" name="north"/>
        <attributeEditorField index="-1" name="ne_accur"/>
        <attributeEditorField index="-1" name="ne_source"/>
      </attributeEditorContainer>
      <attributeEditorContainer name="elevation">
        <attributeEditorField index="-1" name="h_toc"/>
        <attributeEditorField index="-1" name="h_tocags"/>
        <attributeEditorField index="-1" name="h_gs"/>
        <attributeEditorField index="-1" name="h_accur"/>
        <attributeEditorField index="-1" name="h_syst"/>
        <attributeEditorField index="-1" name="h_source"/>
      </attributeEditorContainer>
    </attributeEditorContainer>
    <attributeEditorContainer name="management">
      ...
      <attributeEditorContainer name="comments">
        <attributeEditorField index="-1" name="com_onerow"/>
        <attributeEditorField index="-1" name="com_html"/>
      </attributeEditorContainer>
      <attributeEditorContainer name="programs">
        <attributeEditorField index="-1" name="wmeas_yn"/>
        <attributeEditorField index="-1" name="wlogg_yn"/>
      </attributeEditorContainer>
    </attributeEditorContainer>
  </attributeEditorForm>
  <attributeactions/>
