...
insert into zz_strat(geoshort,strata) values('','unknown');
insert into zz_strat(geoshort,strata) values(' ','unknown');
insert into zz_strat(geoshort,strata) values('okänt','unknown');
insert into zz_strat(geoshort,strata) values('okänd','unknown');
insert into zz_strat(geoshort,strata) values('inget prov','unknown');
insert into "zz_stratigraphy_plots" (strata,color_mplot,hatch_mplot,color_qt,brush_qt) values('unknown','white','','white','NoBrush');
...
insert into "zz_stratigraphy_plots" (strata,color_mplot,hatch_mplot,color_qt,brush_qt) values('coarse gavel','DarkGreen','O','darkGreen','Dense7Pattern');
