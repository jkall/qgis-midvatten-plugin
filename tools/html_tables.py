...
"""
/***************************************************************************
 This is the part of the Midvatten plugin that creates html tables.
 This code is from the HTML module by Philippe Lagadec (v0.04 2009-07-28)
 See Project website: http://www.decalage.info/python/html
 ***************************************************************************/
"""
#--- CONSTANTS -----------------------------------------------------------------
