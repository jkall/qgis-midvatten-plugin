...
class TestCalculateStatistics(utils_for_tests.MidvattenTestSpatialiteDbSv):
    ...
    def test_calculate_statistics(self, mock_selected_features, mock_iface, mock_messagebar):
        ...
        ref = call.info(bar_msg=u'Statistics for table w_levels column meas done, see log for results.', button=True,
                        duration=15,
                        log_msg=u'Obsid;Min;Median;Average;Max;Nr of values\n1;1.0;4.0;3.33333333333;5.0;3\n2;2.0;8.5;7.25;10.0;4')
