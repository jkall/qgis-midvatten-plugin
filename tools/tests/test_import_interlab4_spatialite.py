...
class TestInterlab4ImporterDB(utils_for_tests.MidvattenTestSpatialiteDbSv):
    ...
    def test_interlab4_full_test_to_db_staff_0(self):
        ...
        interlab4_lines = (
            ...
            u'DM-990908-2773;MFR;PG Vejdes väg 15;351 96;Växjö;0780;Demoproj;Demo-Laboratoriet;NSG;0;;Demo1 vattenverk;;Föreskriven regelbunden undersökning enligt SLVFS 2001:30;Dricksvatten enligt SLVFS 2001:30;Utgående;Nej;Tjänligt;;;;2010;2010-09-07;10:15;2010-09-07;14:15;',
            u'#Provdat',
        ...
        reference_string = ur'(True, [(0, None)])'
        assert test_string == reference_string
