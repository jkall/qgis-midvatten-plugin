...
class TestFillDb(utils_for_tests.MidvattenTestPostgisNotCreated):
    ...
    def test_create_db_locale_sv(self, mock_crs_question, mock_answer_yes, mock_not_found, mock_iface, mocked_messagebar):
        ...
        test_string = utils_for_tests.create_test_string(
            db_utils.sql_load_fr_db('select geoshort, strata from zz_strat'))
