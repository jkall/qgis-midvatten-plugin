...
class TestWarnAboutOldDatabase(utils_for_tests.MidvattenTestSpatialiteDbSv):
    ...
    def test_warn_about_old_database(self, mock_messagebar, mock_latest_version):
        ...
        assert call.info(bar_msg='The database version appears to be older than 999.999.999. An upgrade is suggested! See https://github.com/jkall/qgis-midvatten-plugin/wiki/6.-Database-management#upgrade-database', duration=15) in mock_messagebar.mock_calls
