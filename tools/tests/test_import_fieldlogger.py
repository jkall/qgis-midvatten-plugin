...
class TestFieldLoggerImporterNoDb(object):
    ...
    def test_parse_rows_skip_empty_rows(self):
        ...
        test = create_test_string(sorted(observations, key=itemgetter('date_time', 'obsid', 'parametername')))
        reference = sorted([{'date_time': '2016-12-12 15:33:30', 'parametername': 'w_lvl', 'sublocation': 'Br2', 'value': '123'}], key=itemgetter('date_time', 'obsid', 'parametername'))
 ...
 call(combobox_label='Instrument id:s in database for obsid obs2.\nThe last used instrument id for obsid obs2 is prefilled:', default_value='', dialogtitle='Submit instrument id', existing_list=[''], msg='Submit the instrument id for the measurement:\n obs2.sub, obs2, 2016-01-02 00:00:00, atype, aunit')]
    ...
    def test_load_file_delimitor_not_found(self):
        ...
        with utils.tempinput(''.join(f)) as filename:
            ...
            t = sorted(_test(self, filename), key=itemgetter('date_time', 'obsid', 'parametername'))
...
class TestCommentsImportFields(object):
    ...
    def test_alter_data(self):
        ...
        test_string = create_test_string(sorted(observations, key=itemgetter('date_time', 'obsid', 'parametername')))
        reference_string = create_test_string(sorted([{'date_time': '2016-01-01 00:00:00', 'parametername': 'comment', 'skip_comment_import': True, 'sublocation': '1', 'value': 'shared_comment'}, {'comment': 'shared_comment', 'date_time': '2016-01-01 00:00:00', 'parametername': 'par_get_shared_comment', 'sublocation': '1', 'value': '1'}, {'date_time': '2016-01-02 00:00:00', 'parametername': 'par_not_get_shared_comment', 'sublocation': '2', 'value': '1'}, {'date_time': '2016-01-04 00:00:00', 'parametername': 'par_not_get_shared_comment', 'sublocation': '1', 'value': '1'}, {'date_time': '2016-01-03 00:00:00', 'parametername': 'comment', 'sublocation': '1', 'value': 'not_shared_comment'}], key=itemgetter('date_time', 'obsid', 'parametername')))
        assert test_string == reference_string
