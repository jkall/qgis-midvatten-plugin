...
class TestStratigraphy(utils_for_tests.MidvattenTestSpatialiteDbSv):
    ...
    def test_stratigraphy(self, mock_skippopup, mock_messagebar):
        ...
        :return:
        """
        db_utils.sql_alter_db(u'''INSERT INTO obs_points (obsid, h_gs, geometry) VALUES ('P1', 5, GeomFromText('POINT(633466 711659)', 3006))''')
        db_utils.sql_alter_db(u'''INSERT INTO obs_points (obsid, h_toc, geometry) VALUES ('P2', 10, GeomFromText('POINT(6720727 016568)', 3006))''')
