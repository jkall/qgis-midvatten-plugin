...
#
# Created: Thu Apr 10 00:33:01 2014
...
class Ui_SecPlotDock(object):
    def setupUi(self, SecPlotDock):
        ...
        self.DEMlistWidget = QtGui.QListWidget(self.frame)
        self.DEMlistWidget.setObjectName(_fromUtf8("DEMlistWidget"))
        self.verticalLayout_2.addWidget(self.DEMlistWidget)
    ...
    def retranslateUi(self, SecPlotDock):
        ...
        self.label_4.setText(QtGui.QApplication.translate("SecPlotDock", "DEMs:", None, QtGui.QApplication.UnicodeUTF8))
        self.DEMlistWidget.setSortingEnabled(True)
